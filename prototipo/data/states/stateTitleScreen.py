...
class TitleScreen(State):
    ...
    def __load_buttons(self):
        self.TITLE = Button(self._game.fonts_path['title'], 96, (232, 192, 50), 'Speed Archer')
        self.SELECT_1 = Button(self._game.fonts_path['text'], 50, (255, 255, 255), 'Selecionar nível')
        self.SELECT_2 = Button(self._game.fonts_path['text'], 50, (255, 255, 255), 'Criar mapa')
    ...
    def update(self, delta_time, actions):
        if self._game.actions['mouse_left']:
            ...
            if self.SELECT_2.check_for_input(self._game.get_mouse_pos()):
                pass
            if self.SELECT_3.check_for_input(self._game.get_mouse_pos()):
                pass
